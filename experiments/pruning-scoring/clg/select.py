"""Pruning as model selection — report §10.2 and §13 Experiment 4.
...
COMPLEXITY_WEIGHTS = {
    "edges": 0.35,          # branch count — report §11 "number of branches"
...
class Candidate:
    ...
    def error(self) -> float:
        ...
        Report §11 calls symmetric difference "the best optimization loss", and it
...
def simplest_within_tolerance(
    ...
    *,
    ...
    """§13 Experiment 4: the simplest graph that stays within reconstruction tolerance.
