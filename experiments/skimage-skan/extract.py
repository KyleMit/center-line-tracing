...
Report §6.5 (medial_axis with return_distance=True) + §6.7 (Skan as the graph
...
what makes Track 8's width-aware pruning possible.
"""
...
def detect_corners(points: np.ndarray, radii: np.ndarray, angle_deg: float,
    ...
    """Genuine corners kept as C0 breaks before Bézier fitting (§7.4).
...
def skeletonize_mask(mask: np.ndarray, method: str, rng_seed: int = 0
    ...
    NOTE (report §15, determinism): `skimage.morphology.medial_axis` randomises
