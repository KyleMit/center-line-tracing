"""Re-stroke reconstruction metrics (report §11) for the skimage-skan track.
...
def pixel_diff(input_svg: Path, output_svg: Path, size: int = 1200,
    ...
    diff = str(diff_png) if diff_png else "debug/skimage-skan/scratch_diff.png"
...
def failure_tags(graph: CenterlineGraph, results, cfg) -> dict[str, int]:
    """Report §13 Experiment 2 taxonomy, counted mechanically.
