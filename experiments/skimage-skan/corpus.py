"""Synthetic ground-truth corpus (Common Setup §12.1, cases 1-20).
...
Output:
    debug/skimage-skan/corpus/<nn>-<name>.svg      filled shape, one <path> per element
    debug/skimage-skan/corpus/corpus.json          ground truth
"""
...
OUT = REPO / "debug" / "skimage-skan" / "corpus"
...
def write(cases: list[dict]) -> dict:
    ...
    for case in cases:
        ...
        manifest["cases"].append({
            ...
            "num": case["num"],
            "name": case["name"],
            "svg": f"debug/skimage-skan/corpus/{case['id']}.svg",
            "notes": case["notes"],
            "radius": case["radius"],
