"""The common centerline graph model (Common Setup §13).
...
Extra fields, all documented in debug/skimage-skan/NOTES.md:
  ...
  edge.normLength      length / (2 * medianRadius)   <- Track 8's pruning feature
...
def validate(doc: dict[str, Any]) -> list[str]:
    """Cheap structural check — mirrors what Track 8's validator should enforce."""
    problems: list[str] = []
